 ...
 */
public class BasicEvaluationDAOImplPostgre extends AbstractDAOPostgreSQL implements BasicEvaluationDAO{
    ...
    public void loadEvaluations(Restaurant restaurant) throws ConnectionProblemException{
        ...
        try {
            ...
            throw new ConnectionProblemException("A problem appeared while loading a restaurant's basic evaluations", sqlE);
        }finally {
            closeStmtAndRS(stmt, rs);
        }
    }
